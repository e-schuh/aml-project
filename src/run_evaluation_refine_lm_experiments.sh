...
# Output path
OUTPUT_PATH="${TOP_LEVEL_DIR}/evaluation_output/eval_metrics_SwissBert_refine_lm_debiased_de.json"

# Loop over files in inference_output directory
for file in ${TOP_LEVEL_DIR}/inference_output/combined_results*_debiased*; do
    FILE_PATH_PRED="$file"
