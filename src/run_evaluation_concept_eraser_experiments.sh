...
# Output path
OUTPUT_PATH="${TOP_LEVEL_DIR}/evaluation_output/eval_metrics_SwissBert_concept_erasers_de.json"

# Loop over files in inference_output directory
for file in ${TOP_LEVEL_DIR}/inference_output/combined_results*_eraser*; do
    FILE_PATH_PRED="$file"
